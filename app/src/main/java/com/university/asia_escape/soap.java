...
public class soap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageView bg = (ImageView) findViewById(R.id.imageView);
        final value gv = (value) getApplicationContext();//變數呼叫
        final Button getsoap = (Button) findViewById(R.id.getsoap);
...
//endregion
        if (gv.getN7() == 0) {
            bg.setImageDrawable(getDrawable(R.drawable.college_design_coin));
            talk.setText("肥皂盒裡面好像有東西");
        }
        if(gv.getN7()!=0){
            getsoap.setVisibility(View.INVISIBLE);
            talk.setText("已經拿走肥皂了");
        }
        getsoap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gv.setN7(1);
                ibtns[6].setVisibility(View.VISIBLE);
                bg.setImageDrawable(getDrawable(R.drawable.college_design_nocoin));
                talk.setText("拿到肥皂了");
        ...
        close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(soap.this, wc.class);
