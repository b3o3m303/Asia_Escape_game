...
public class fireview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fireview);
         //region 每一頁都有
...
//endregion
//endregion
        final Button getkey=(Button)findViewById(R.id.getkey);
        final ImageView bg=(ImageView) findViewById(R.id.imageView4);
        //region 選擇背景
        if(gv.getN1()==1){
            bg.setImageDrawable(getDrawable(R.drawable.lab_out_nokey));
        ...
        left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(fireview.this,lab.class);
                startActivity(intent);
                fireview.this.finish();
            }
        });
        //endregion
