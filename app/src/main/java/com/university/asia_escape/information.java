...
//endregion
        ...
        final Button screwdriver=(Button)findViewById(R.id.screwdriver);
        talk.setText("資訊電機學院");
        //region 螺絲起子
    ...
    public void jumpH() {
        ...
        intent.setClass(information.this, health.class);
    ...
    public void jumpA() {
        Intent intent = new Intent();
        intent.setClass(information.this, art.class);
        startActivity(intent);
        information.this.finish();
    }
    public void openhost() {
        Intent intent = new Intent();
        intent.setClass(information.this, host.class);
        startActivity(intent);
        information.this.finish();
    }
    public void getscrewderiver() {
        Intent intent = new Intent();
        intent.setClass(information.this, screwdriver.class);
        startActivity(intent);
        information.this.finish();
    }
}
