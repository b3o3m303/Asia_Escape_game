...
//endregion
        //endregion
        //region 該頁宣告
        final Button fire = (Button) findViewById(R.id.fire);
        final Button door = (Button) findViewById(R.id.door);
        ...
        fire.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(lab.this, fireview.class);
        ...
        left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(lab.this, health.class);
                startActivity(intent);
                lab.this.finish();
            }
        });
        ...
        //region 開實驗室門
            door.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(gv.getN1()==1){
                        talk.setText("用撿到的鑰匙開門了");
                        Handler handler = new Handler();
                        handler.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                Intent intent = new Intent();
                                intent.setClass(lab.this, labin.class);
                                startActivity(intent);
                                lab.this.finish();
                            }
                        }, 500);
                    }else{
                        talk.setText("門鎖住了，打不開啊!");
                    }
                }
            });
        //endregion
