...
//endregion
        //region 該頁宣告
        final Button beaker=(Button) findViewById(R.id.beaker);
        final Button gointo=(Button) findViewById(R.id.gointo);
        ...
        //region 判斷底圖
        if(gv.getN5()==0){
            bg.setImageDrawable(getDrawable(R.drawable.college_management_beaker));
            beaker.setVisibility(View.VISIBLE);
        }
        ...
        //endregion
        //region 撿燒杯
        beaker.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                talk.setText("撿到一個燒杯");
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        talk.setText("呃...是誰會把燒杯放在這邊啊");
                    }
                }, 1000);
                bg.setImageDrawable(getDrawable(R.drawable.college_management_view));
                gv.setN5(1);
                ibtns[4].setVisibility(View.VISIBLE);
                beaker.setVisibility(View.INVISIBLE);
            }
        });
        //endregion
    ...
    public void jumpH() {
        ...
        intent.setClass(management.this, health.class);
    ...
    public void GO() {
        Intent intent = new Intent();
        intent.setClass(management.this,mangement2f.class);
        startActivity(intent);
        management.this.finish();
    }
}
