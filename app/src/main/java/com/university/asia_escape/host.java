...
//endregion
        ...
        close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(host.this, information.class);
        ...
        //region 置換背景
        if (gv.getPASS5() == 1) {
            bg.setImageDrawable(getDrawable(R.drawable.college_information_right_open));
        ...
        if(gv.getPASS5() == 1&&gv.getN11()==1){
            talk.setText("已經拿過地圖，去找別的地方吧");
        }
        //endregion
        //region開主機蓋
        open.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (gv.getN10() == 1) {
                    gv.setPASS5(1);
                    bg.setImageDrawable(getDrawable(R.drawable.college_information_right_open));
                    talk.setText("用螺絲起子打開蓋子了");
                    open.setVisibility(View.INVISIBLE);
                    paper.setEnabled(true);
                } else {
                    talk.setText("裡面有東西，但是蓋子被螺絲鎖住了");
                }
            }
        });
        //endregion
