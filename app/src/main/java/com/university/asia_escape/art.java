...
//endregion
//endregion
        final Button machine = (Button) findViewById(R.id.vendingmachine);
        //region 左轉 G
    ...
    public void jumpG() {
        ...
        intent.setClass(art.this, MainActivity.class);
    ...
    public void jumpI() {
        Intent intent = new Intent();
        intent.setClass(art.this, information.class);
        startActivity(intent);
        art.this.finish();
    }
    ...
    public void jumpV() {
        Intent intent = new Intent();
        intent.setClass(art.this, vendingmachine.class);
        startActivity(intent);
        art.this.finish();
    }
