...
public class mangement2f extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mangement2f);
        //region 每一頁都有
...
//endregion
        ...
        final Button getfire = (Button) findViewById(R.id.getfire);
        final Button bag = (Button) findViewById(R.id.bag);
        //endregion
        //region 返回
        ...
        //region 判斷底圖
        if (gv.getN12() == 1) {
            bg.setImageDrawable(getDrawable(R.drawable.college_management));
            getfire.setVisibility(View.INVISIBLE);
        }

        //endregion
        //region 得到火柴
        getfire.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                gv.setN12(1);
                talk.setText("撿到火柴，該拿來許願嗎?");
                ibtns[11].setVisibility(View.VISIBLE);
                getfire.setVisibility(View.INVISIBLE);
                bg.setImageDrawable(getDrawable(R.drawable.college_management));
            }
        ...
        //endregion
        talk.setText("椅子上有一個奇怪的包包");
    }

    public void gobackM1f() {
        Intent intent = new Intent();
        intent.setClass(mangement2f.this, management.class);
        startActivity(intent);
        mangement2f.this.finish();
    }

    public void jumpbag() {
        Intent intent = new Intent();
        intent.setClass(mangement2f.this, checkbag.class);
        startActivity(intent);
        mangement2f.this.finish();
    }
}
